  ...
  let bodyCategory = `
    <form class="updateCategoryForm">
      <div class="form-group">
        ...
        <input type="text" class="form-control" maxlength="45" id="updatedName" value="${dataCategory.name}">
      </div>
      <div class="form-group">
        <label for="updatedDescription" class="form-label">Descripción</label>
        <textarea maxlength="250" class="form-control" id="updatedDescription">${dataCategory.description}</textarea>
      </div>
