...
import com.miguelparada.retocuatro.repository.UserRepository;
...
public class UserService {
    ...
    public User create(User user) {
        if (user.getId() == null) {
            int lastId = userRepository.getLastId();
            user.setId(lastId + 1);
    ...
    public List<User> getUserByMonthBirthDay(String monthBirthDay) {
        return userRepository.getUserByMonthBirthDay(monthBirthDay);
    }
}
