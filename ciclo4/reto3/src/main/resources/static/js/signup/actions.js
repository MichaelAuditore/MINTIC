...
async function registerEvent() {
  ...
  if (validRegister.status) {
    let body = {
      ...
      identification: $("#identification").val() != "" ? $("#identification").val() : null,
      address: $("#address").val() != "" ? $("#address").val() : null,
      cellPhone: $("#cellPhone").val() != "" ? $("#cellPhone").val() : null,
      zone: $("#zone").val() != "" ? $("#zone").val() : null,
      type: $("#typeRol").val() != "" ? $("#typeRol").val() : null,
    };
