  ...
  data.forEach((message) => {
    ...
    `;
    {
      /* <td class="actionButtons">
          <button id="edit-${message.idMessage}" class="btn btn-warning">Editar</button>
          <button id="delete-${message.idMessage}" class="btn btn-danger deleteMessage">Eliminar</button>
        </td> */
    }
...
async function drawEdit(event) {
  ...
  let bodyMessage = `
    <form class="updateMessageForm">
      <div class="form-group">
        <label for="computerSelect" class="form-label">Mensaje</label>
